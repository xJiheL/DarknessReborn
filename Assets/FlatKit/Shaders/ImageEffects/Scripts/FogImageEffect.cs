...
namespace FlatKit {
    ...
    public class FogImageEffect : MonoBehaviour {
        ...
        void Awake() {
            _material = new Material(Shader.Find("Hidden/FogPlus"));
        ...
        private void UpdateShader() {
            ...
            _material.SetFloat(Near, near);
            _material.SetFloat(Far, far);
            _material.SetFloat(UseDistanceFog, useDistance ? 1f : 0f);
            _material.SetFloat(UseDistanceFogOnSky, useDistanceFogOnSky ? 1f : 0f);
            _material.SetFloat(DistanceFogIntensity, distanceFogIntensity);

            UpdateHeightLut();
            _material.SetTexture(HeightLut, _lutHeight);
            _material.SetFloat(LowWorldY, low);
            _material.SetFloat(HighWorldY, high);
            _material.SetFloat(UseHeightFog, useHeight ? 1f : 0f);
            _material.SetFloat(UseHeightFogOnSky, useHeightFogOnSky ? 1f : 0f);
            _material.SetFloat(HeightFogIntensity, heightFogIntensity);

            _material.SetFloat(DistanceHeightBlend, distanceHeightBlend);
        }
